...
function abril2024(){
    ...
    //Precio de referencia pagado al productor
    monthYear.textContent = "Abril 2024";
    cantTambos.textContent = "1477";
    precioPorLitro.textContent = "368,87";
    variacion1.textContent = "7,73%";
    variacion2.textContent = "297,79%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 384,78";
    pCAbasSur.textContent = "$ 360,53";
    pCMyS.textContent = "$ 370,57";
    pCO.textContent = "$ 368,73";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "301,1%";
    aNcruIMen.textContent = "8,18%";
    aSurcruIA.textContent = "295,97%";
    aSurcruIMen.textContent = "8,36%";
    mYScruIA.textContent = "296,3%";
    mYScruIMen.textContent = "7,22%";
    oescruIA.textContent = "298,67%";
    oescruIMen.textContent = "7,6%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "4951,56";
    precio_solidos_UTvar_IMen.textContent = "5,51%";
    precio_x_kg_solidos_UTvar_IA.textContent = "294,99%";
    proteina.textContent = "3,52%";
    grasa_butirosa.textContent = "3,93%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "156,5";
    produ_lechcrudIMen.textContent = "-2,88%";
    produ_lechecrudaIA.textContent = "-8,14%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a abril '23";
    dato_comparativo_1.textContent = "677,76";
    mes_comparativo_2.textContent = "Acumulado a abril '24";
    dato_comparativo_2.textContent = "639,17";
    porcentaje_comparativo.textContent = "-5,69%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-24,6%";
    aN_Li_x_c_Men.textContent = "-5,4%";
    aSur_Li_x_c_IA.textContent = "-11%";
    aSur_Li_x_c_IMen.textContent = "-4,3%";
    mYS_Li_x_c_IA.textContent = "-5%";
    mYS_Li_x_c_IMen.textContent = "-1,7%";
    oes_Li_x_c_IA.textContent = "-6,1%";
    oes_Li_x_c_IMen.textContent = "-2,2%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,47%";
    s_cuenAbasSur.textContent = "7,26%";
    s_cuenMyS.textContent = "7,49%";
    s_cuenO.textContent = "7,43%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['Abr 23','May 23','Jun 23','Jul 23','Ago 23','Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24'];
    graf_precio_litro.data.datasets[0].data = [92.73,100.74,107.39,112.51,117.42,122.66,133.39,151.47,193.79,246.11,298.57,342.39,368.87];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [170.36,176.63,177.32,191.13,209.23,212.88,223.64,207.35,195.98,174.88,146.65,161.14,156.5];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.4,7.47,7.39,7.36,7.27,7.24,7.20,7.19,7.13,7.07,7.23,7.3,7.45];
...
function mayo2024(){
    ...
    //Precio de referencia pagado al productor
    monthYear.textContent = "Mayo 2024";
    cantTambos.textContent = "1490";
    precioPorLitro.textContent = "401,26";
    variacion1.textContent = "8,78%";
    variacion2.textContent = "298,35%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 418,83";
    pCAbasSur.textContent = "$ 389,04";
    pCMyS.textContent = "$ 406,8";
    pCO.textContent = "$ 401,11";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "299,9%";
    aNcruIMen.textContent = "8,8%";
    aSurcruIA.textContent = "292,9%";
    aSurcruIMen.textContent = "7,9%";
    mYScruIA.textContent = "299%";
    mYScruIMen.textContent = "9,8%";
    oescruIA.textContent = "299,6%";
    oescruIMen.textContent = "8,7%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "5304,48";
    precio_solidos_UTvar_IMen.textContent = "7,13%";
    precio_x_kg_solidos_UTvar_IA.textContent = "293,2%";
    proteina.textContent = "3,6%";
    grasa_butirosa.textContent = "3,96%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "166,62";
    produ_lechcrudIMen.textContent = "6,47%";
    produ_lechecrudaIA.textContent = "-5,67%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a mayo '23";
    dato_comparativo_1.textContent = "854,39";
    mes_comparativo_2.textContent = "Acumulado a mayo '24";
    dato_comparativo_2.textContent = "805,79";
    porcentaje_comparativo.textContent = "-5,7%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-21,4%";
    aN_Li_x_c_Men.textContent = "7,1%";
    aSur_Li_x_c_IA.textContent = "-9,2%";
    aSur_Li_x_c_IMen.textContent = "5%";
    mYS_Li_x_c_IA.textContent = "-4%";
    mYS_Li_x_c_IMen.textContent = "4,2%";
    oes_Li_x_c_IA.textContent = "-3,1%";
    oes_Li_x_c_IMen.textContent = "7,7%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,47%";
    s_cuenAbasSur.textContent = "7,32%";
    s_cuenMyS.textContent = "7,7%";
    s_cuenO.textContent = "7,56%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['May 23','Jun 23','Jul 23','Ago 23','Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24'];
    graf_precio_litro.data.datasets[0].data = [100.74,107.39,112.51,117.42,122.66,133.39,151.47,193.79,246.11,298.57,342.39,368.87,401.26];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [176.63,177.32,191.13,209.23,212.88,223.64,207.35,195.98,174.88,146.65,161.14,156.5,166.62];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.47,7.39,7.36,7.27,7.24,7.20,7.19,7.13,7.07,7.23,7.3,7.45,7.56];
...
function junio2024(){
    ...
    //Precio de referencia pagado al productor
    monthYear.textContent = "Junio 2024";
    cantTambos.textContent = "1452";
    precioPorLitro.textContent = "421,8";
    variacion1.textContent = "5,12%";
    variacion2.textContent = "292,77%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 436,52";
    pCAbasSur.textContent = "$ 411,62";
    pCMyS.textContent = "$ 426,49";
    pCO.textContent = "$ 421,55";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "295,3%";
    aNcruIMen.textContent = "4,2%";
    aSurcruIA.textContent = "291,6%";
    aSurcruIMen.textContent = "5,8%";
    mYScruIA.textContent = "289,8%";
    mYScruIMen.textContent = "4,8%";
    oescruIA.textContent = "293,6%";
    oescruIMen.textContent = "5,1%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "5662,87";
    precio_solidos_UTvar_IMen.textContent = "6,76%";
    precio_x_kg_solidos_UTvar_IA.textContent = "289,65%";
    proteina.textContent = "3,56%";
    grasa_butirosa.textContent = "3,89%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "170,53";
    produ_lechcrudIMen.textContent = "2,4%";
    produ_lechecrudaIA.textContent = "-3,8%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    ...
    mes_comparativo_1.textContent = "Acumulado a junio '23";
    dato_comparativo_1.textContent = "1031,7";
    mes_comparativo_2.textContent = "Acumulado a junio '24";
    dato_comparativo_2.textContent = "976,3";
    porcentaje_comparativo.textContent = "-5,3%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-20%";
    aN_Li_x_c_Men.textContent = "3,2%";
    aSur_Li_x_c_IA.textContent = "-11,9%";
    aSur_Li_x_c_IMen.textContent = "0,3%";
    mYS_Li_x_c_IA.textContent = "-4%";
    mYS_Li_x_c_IMen.textContent = "-4,2%";
    oes_Li_x_c_IA.textContent = "0,6%";
    oes_Li_x_c_IMen.textContent = "4,7%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,42%";
    ...
    graf_precio_litro.data.labels = ['Jun 23','Jul 23','Ago 23','Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24'];
    graf_precio_litro.data.datasets[0].data = [107.39,112.51,117.42,122.66,133.39,151.47,193.79,246.11,298.57,342.39,368.87,401.26,421.8];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [177.32,191.13,209.23,212.88,223.64,207.35,195.98,174.88,146.65,161.14,156.5,166.62,170.53];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.39,7.36,7.27,7.24,7.20,7.19,7.13,7.07,7.23,7.3,7.45,7.56,7.45];
...
function julio2024(){
    ...
    //Precio de referencia pagado al productor
    monthYear.textContent = "Julio 2024";
    cantTambos.textContent = "1478";
    precioPorLitro.textContent = "430,58";
    variacion1.textContent = "2,08%";
    variacion2.textContent = "282,7%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 445,22";
    pCAbasSur.textContent = "$ 419,71";
    pCMyS.textContent = "$ 431,42";
    pCO.textContent = "$ 431,78";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "285,4%";
    aNcruIMen.textContent = "1,9%";
    aSurcruIA.textContent = "281,6%";
    aSurcruIMen.textContent = "1,9%";
    mYScruIA.textContent = "278,8%";
    mYScruIMen.textContent = "1,2%";
    oescruIA.textContent = "283,7%";
    oescruIMen.textContent = "2,4%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "5810,04";
    precio_solidos_UTvar_IMen.textContent = "2,6%";
    precio_x_kg_solidos_UTvar_IA.textContent = "279,92%";
    proteina.textContent = "3,56%";
    grasa_butirosa.textContent = "3,85%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "192,91";
    produ_lechcrudIMen.textContent = "13,12%";
    produ_lechecrudaIA.textContent = "0,93%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a julio '23";
    dato_comparativo_1.textContent = "1222,84";
    mes_comparativo_2.textContent = "Acumulado a julio '24";
    dato_comparativo_2.textContent = "1169,23";
    porcentaje_comparativo.textContent = "-4,4%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-14,1%";
    aN_Li_x_c_Men.textContent = "15,1%";
    aSur_Li_x_c_IA.textContent = "-1,9%";
    aSur_Li_x_c_IMen.textContent = "22,2%";
    mYS_Li_x_c_IA.textContent = "0,5%";
    mYS_Li_x_c_IMen.textContent = "6,9%";
    oes_Li_x_c_IA.textContent = "3,7%";
    oes_Li_x_c_IMen.textContent = "12,3%";
    ...
    graf_precio_litro.data.labels = ['Jul 23','Ago 23','Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24'];
    graf_precio_litro.data.datasets[0].data = [112.51,117.42,122.66,133.39,151.47,193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [191.13,209.23,212.88,223.64,207.35,195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.36,7.27,7.24,7.20,7.19,7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41];
...
function agosto2024(){
    ...
    //Precio de referencia pagado al productor
    monthYear.textContent = "Agosto 2024";
    cantTambos.textContent = "1482";
    precioPorLitro.textContent = "441,6";
    variacion1.textContent = "2,6%";
    variacion2.textContent = "276,1%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 457,6";
    pCAbasSur.textContent = "$ 432,28";
    pCMyS.textContent = "$ 441,2";
    pCO.textContent = "$ 442,85";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "279,7%";
    aNcruIMen.textContent = "2,8%";
    aSurcruIA.textContent = "276%";
    aSurcruIMen.textContent = "3%";
    mYScruIA.textContent = "273,7%";
    mYScruIMen.textContent = "2,3%";
    oescruIA.textContent = "276,9%";
    oescruIMen.textContent = "2,6%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6030,92";
    precio_solidos_UTvar_IMen.textContent = "3,8%";
    precio_x_kg_solidos_UTvar_IA.textContent = "273,5%";
    proteina.textContent = "3,52%";
    grasa_butirosa.textContent = "3,8%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "206,94";
    produ_lechcrudIMen.textContent = "7,3%";
    produ_lechecrudaIA.textContent = "-1,1%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a Agosto '23";
    dato_comparativo_1.textContent = "1432,07";
    mes_comparativo_2.textContent = "Acumulado a Agosto '24";
    dato_comparativo_2.textContent = "1376,17";
    porcentaje_comparativo.textContent = "-3,9%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-18,9%";
    aN_Li_x_c_Men.textContent = "3,7%";
    aSur_Li_x_c_IA.textContent = "-3,2%";
    aSur_Li_x_c_IMen.textContent = "6,9%";
    mYS_Li_x_c_IA.textContent = "-1,9%";
    mYS_Li_x_c_IMen.textContent = "12,3%";
    oes_Li_x_c_IA.textContent = "1,6%";
    oes_Li_x_c_IMen.textContent = "6,8%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,31%";
    s_cuenAbasSur.textContent = "7,11%";
    s_cuenMyS.textContent = "7,28%";
    s_cuenO.textContent = "7,34%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['Ago 23','Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24'];
    graf_precio_litro.data.datasets[0].data = [117.42,122.66,133.39,151.47,193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [209.23,212.88,223.64,207.35,195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.27,7.24,7.20,7.19,7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32];
...
function septiembre2024(){

    //Precio de referencia pagado al productor
    monthYear.textContent = "Septiembre 2024";
    cantTambos.textContent = "1499";
    precioPorLitro.textContent = "443,85";
    variacion1.textContent = "0,51%";
    variacion2.textContent = "261,85%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 463,25";
    pCAbasSur.textContent = "$ 434,47";
    pCMyS.textContent = "$ 444,55";
    pCO.textContent = "$ 444,27";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "268,2%";
    aNcruIMen.textContent = "1,2%";
    aSurcruIA.textContent = "263%";
    aSurcruIMen.textContent = "0,5%";
    mYScruIA.textContent = "259,6%";
    mYScruIMen.textContent = "0,7%";
    oescruIA.textContent = "261,9%";
    oescruIMen.textContent = "0,3%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6132,36";
    precio_solidos_UTvar_IMen.textContent = "1,7%";
    precio_x_kg_solidos_UTvar_IA.textContent = "261,9%";
    proteina.textContent = "3,51%";
    grasa_butirosa.textContent = "3,73%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "217,34";
    produ_lechcrudIMen.textContent = "5,03%";
    produ_lechecrudaIA.textContent = "2,1%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    ...
    mes_comparativo_1.textContent = "Acumulado a Septiembre '23";
    dato_comparativo_1.textContent = "1644,95";
    mes_comparativo_2.textContent = "Acumulado a Septiembre '24";
    dato_comparativo_2.textContent = "1593,51";
    porcentaje_comparativo.textContent = "-3,13%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-14,2%";
    aN_Li_x_c_Men.textContent = "7,5%";
    aSur_Li_x_c_IA.textContent = "0,5%";
    aSur_Li_x_c_IMen.textContent = "3,7%";
    mYS_Li_x_c_IA.textContent = "3,3%";
    mYS_Li_x_c_IMen.textContent = "11,2%";
    oes_Li_x_c_IA.textContent = "3,7%";
    oes_Li_x_c_IMen.textContent = "3,6%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,26%";
    s_cuenAbasSur.textContent = "7,03%";
    s_cuenMyS.textContent = "7,12%";
    s_cuenO.textContent = "7,27%";
    ...
    graf_precio_litro.data.labels = ['Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24'];
    graf_precio_litro.data.datasets[0].data = [122.66,133.39,151.47,193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [212.88,223.64,207.35,195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.24,7.20,7.19,7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24];
...
function octubre2024(){

    //Precio de referencia pagado al productor
    monthYear.textContent = "Octubre 2024";
    cantTambos.textContent = "1502";
    precioPorLitro.textContent = "447,62";
    variacion1.textContent = "0,85%";
    variacion2.textContent = "235,57%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 463,28";
    pCAbasSur.textContent = "$ 440,77";
    pCMyS.textContent = "$ 451,22";
    pCO.textContent = "$ 446,77";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "237,7%";
    aNcruIMen.textContent = "0,01%";
    aSurcruIA.textContent = "238,9%";
    aSurcruIMen.textContent = "1,4%";
    mYScruIA.textContent = "235,3%";
    mYScruIMen.textContent = "1,5%";
    oescruIA.textContent = "234,6%";
    oescruIMen.textContent = "0,5%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6231,4";
    precio_solidos_UTvar_IMen.textContent = "1,6%";
    precio_x_kg_solidos_UTvar_IA.textContent = "236,4%";
    proteina.textContent = "3,49%";
    grasa_butirosa.textContent = "3,70%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "231,3";
    produ_lechcrudIMen.textContent = "6,42%";
    produ_lechecrudaIA.textContent = "3,43%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    ...
    mes_comparativo_1.textContent = "Acumulado a Octubre '23";
    dato_comparativo_1.textContent = "1868,59";
    mes_comparativo_2.textContent = "Acumulado a Octubre '24";
    dato_comparativo_2.textContent = "1824,81";
    porcentaje_comparativo.textContent = "-2,34%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-12,8%";
    aN_Li_x_c_Men.textContent = "6,6%";
    aSur_Li_x_c_IA.textContent = "1,7%";
    aSur_Li_x_c_IMen.textContent = "7,3%";
    mYS_Li_x_c_IA.textContent = "5,6%";
    mYS_Li_x_c_IMen.textContent = "8,4%";
    oes_Li_x_c_IA.textContent = "5,8%";
    oes_Li_x_c_IMen.textContent = "6,3%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,14%";
    s_cuenAbasSur.textContent = "7,02%";
    s_cuenMyS.textContent = "7,23%";
    s_cuenO.textContent = "7,18%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24','Oct 24'];
    graf_precio_litro.data.datasets[0].data = [133.39,151.47,193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85,447.62];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [223.64,207.35,195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34,231.3];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.20,7.19,7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24,7.18];
...
function noviembre2024(){

    //Precio de referencia pagado al productor
    monthYear.textContent = "Noviembre 2024";
    cantTambos.textContent = "1503";
    precioPorLitro.textContent = "452,11";
    variacion1.textContent = "1%";
    variacion2.textContent = "198,5%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 476,06";
    pCAbasSur.textContent = "$ 444,39";
    pCMyS.textContent = "$ 454,07";
    pCO.textContent = "$ 450,88";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "209,1%";
    aNcruIMen.textContent = "2,7%";
    aSurcruIA.textContent = "202,7%";
    aSurcruIMen.textContent = "0,8%";
    mYScruIA.textContent = "194,4%";
    mYScruIMen.textContent = "0,6%";
    oescruIA.textContent = "197,3%";
    oescruIMen.textContent = "0,9%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6360,43";
    precio_solidos_UTvar_IMen.textContent = "2,1%";
    precio_x_kg_solidos_UTvar_IA.textContent = "202,1%";
    proteina.textContent = "3,45%";
    grasa_butirosa.textContent = "3,66%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "217,3";
    produ_lechcrudIMen.textContent = "-6,05%";
    produ_lechecrudaIA.textContent = "4,8%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a Noviembre '23";
    dato_comparativo_1.textContent = "2075,94";
    mes_comparativo_2.textContent = "Acumulado a Noviembre '24";
    dato_comparativo_2.textContent = "2042,11";
    porcentaje_comparativo.textContent = "-1,63%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-8,7%";
    aN_Li_x_c_Men.textContent = "-5,5%";
    aSur_Li_x_c_IA.textContent = "3,7%";
    aSur_Li_x_c_IMen.textContent = "-7,5%";
    mYS_Li_x_c_IA.textContent = "6,1%";
    mYS_Li_x_c_IMen.textContent = "-7,6%";
    oes_Li_x_c_IA.textContent = "6,2%";
    oes_Li_x_c_IMen.textContent = "-5,7%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,10%";
    s_cuenAbasSur.textContent = "6,93%";
    s_cuenMyS.textContent = "7,08%";
    s_cuenO.textContent = "7,13%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['Nov 23','Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24','Oct 24','Nov 24'];
    graf_precio_litro.data.datasets[0].data = [151.47,193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85,447.62,452.11];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [207.35,195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34,231.3,217.3];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.19,7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24,7.18,7.11];
...
function diciembre2024(){

    //Precio de referencia pagado al productor
    monthYear.textContent = "Diciembre 2024";
    cantTambos.textContent = "1488";
    precioPorLitro.textContent = "456,12";
    variacion1.textContent = "0,89%";
    variacion2.textContent = "135,37%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 483,92";
    pCAbasSur.textContent = "$ 449,71";
    pCMyS.textContent = "$ 454,13";
    pCO.textContent = "$ 454,86";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "147,9%";
    aNcruIMen.textContent = "1,6%";
    aSurcruIA.textContent = "141,4%";
    aSurcruIMen.textContent = "1,2%";
    mYScruIA.textContent = "130,8%";
    mYScruIMen.textContent = "0,01%";
    oescruIA.textContent = "133,8%";
    oescruIMen.textContent = "0,9%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6424,83";
    precio_solidos_UTvar_IMen.textContent = "1,01%";
    precio_x_kg_solidos_UTvar_IA.textContent = "136,5%";
    proteina.textContent = "3,44%";
    grasa_butirosa.textContent = "3,66%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "215,24";
    produ_lechcrudIMen.textContent = "-0,95%";
    produ_lechecrudaIA.textContent = "9,83%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a Diciembre '23";
    dato_comparativo_1.textContent = "2271,92";
    mes_comparativo_2.textContent = "Acumulado a Diciembre '24";
    dato_comparativo_2.textContent = "2257,35";
    porcentaje_comparativo.textContent = "-0,64%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-1,7%";
    aN_Li_x_c_Men.textContent = "-2%";
    aSur_Li_x_c_IA.textContent = "13,5%";
    aSur_Li_x_c_IMen.textContent = "2,7%";
    mYS_Li_x_c_IA.textContent = "11,1%";
    mYS_Li_x_c_IMen.textContent = "-2,9%";
    oes_Li_x_c_IA.textContent = "9,5%";
    oes_Li_x_c_IMen.textContent = "-1,6%";
    ...
    s_cuenAbasNort.textContent = "7,09%";
    s_cuenAbasSur.textContent = "6,98%";
    s_cuenMyS.textContent = "7,10%";
    s_cuenO.textContent = "7,10%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24','Oct 24','Nov 24','Dic 24'];
    graf_precio_litro.data.datasets[0].data = [193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85,447.62,452.11,456.12];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34,231.3,217.3,215.24];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24,7.18,7.11,7.10];
...
function enero2025(){
    ...
    //Precio de referencia pagado al productor
    monthYear.textContent = "Enero 2025";
    cantTambos.textContent = "1481";
    precioPorLitro.textContent = "458,59";
    variacion1.textContent = "0,54%";
    variacion2.textContent = "86,34%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 487,69";
    pCAbasSur.textContent = "$ 451,26";
    pCMyS.textContent = "$ 463,47";
    pCO.textContent = "$ 456,33";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "95,6%";
    aNcruIMen.textContent = "0,8%";
    aSurcruIA.textContent = "89,4%";
    aSurcruIMen.textContent = "0,3%";
    mYScruIA.textContent = "83,5%";
    mYScruIMen.textContent = "2,06%";
    oescruIA.textContent = "84,9%";
    oescruIMen.textContent = "0,3%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6489,35";
    precio_solidos_UTvar_IMen.textContent = "1%";
    precio_x_kg_solidos_UTvar_IA.textContent = "86,54%";
    proteina.textContent = "3,41%";
    grasa_butirosa.textContent = "3,65%";

    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "194,85";
    produ_lechcrudIMen.textContent = "-9,74%";
    produ_lechecrudaIA.textContent = "11,42%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a Enero '24";
    dato_comparativo_1.textContent = "174,88";
    mes_comparativo_2.textContent = "Acumulado a Enero '25";
    dato_comparativo_2.textContent = "194,85";
    porcentaje_comparativo.textContent = "11,42%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "-2,5%";
    aN_Li_x_c_Men.textContent = "-10,9%";
    aSur_Li_x_c_IA.textContent = "17,3%";
    aSur_Li_x_c_IMen.textContent = "-5,2%";
    mYS_Li_x_c_IA.textContent = "12,6%";
    mYS_Li_x_c_IMen.textContent = "-6,6%";
    oes_Li_x_c_IA.textContent = "10,7%";
    oes_Li_x_c_IMen.textContent = "-11,7%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,10%";
    s_cuenAbasSur.textContent = "6,97%";
    s_cuenMyS.textContent = "7,11%";
    s_cuenO.textContent = "7,05%";


    //Gráfico1
    
    graf_precio_litro.data.labels = ['Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24','Oct 24','Nov 24','Dic 24','Ene 25'];
    graf_precio_litro.data.datasets[0].data = [246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85,447.62,452.11,456.12,458.59];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34,231.3,217.3,215.24,194.85];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24,7.18,7.11,7.10,7.07];
...
function febrero2025(){

    //Precio de referencia pagado al productor
    monthYear.textContent = "Febrero 2025";
    cantTambos.textContent = "1480";
    precioPorLitro.textContent = "462,39";
    variacion1.textContent = "0,8%";
    variacion2.textContent = "54,8%";

    //Precio por Cuencas Lecheras
    pCAbasNort.textContent = "$ 485,19";
    pCAbasSur.textContent = "$ 454,64";
    pCMyS.textContent = "$ 473,14";
    pCO.textContent = "$ 459,57";

    //Variación del $/ Lt. Leche cruda por Cuenca lechera
    aNcruIA.textContent = "58,2%";
    aNcruIMen.textContent = "-0,5%";
    aSurcruIA.textContent = "56,6%";
    aSurcruIMen.textContent = "0,7%";
    mYScruIA.textContent = "54,4%";
    mYScruIMen.textContent = "2,1%";
    oescruIA.textContent = "54,1%";
    oescruIMen.textContent = "0,7%";

    //Parámetros de composición y evolución de precio SU
    precio_solidos_UT.textContent = "6412,7";
    precio_solidos_UTvar_IMen.textContent = "-1,2%";
    precio_x_kg_solidos_UTvar_IA.textContent = "55,4%";
    proteina.textContent = "3,46%";
    grasa_butirosa.textContent = "3,75%";
    ...
    //Evolución del volumen mensual en MM de litros de leche cruda
    cantTambos2.textContent = (cantTambos.textContent);
    prod_mensual_lech_crud.textContent = "163,57";
    produ_lechcrudIMen.textContent = "-16,05%";
    produ_lechecrudaIA.textContent = "11,54%";
    var_int_0.textContent = "No espefic %";
    var_int_2019.textContent = "No espefic %";
    var_int_2020.textContent = "No espefic %";
    anio_0.textContent = "0";
    ...
    mes_comparativo_1.textContent = "Acumulado a Febrero '24";
    dato_comparativo_1.textContent = "321,53";
    mes_comparativo_2.textContent = "Acumulado a Febrero '25";
    dato_comparativo_2.textContent = "358,42";
    porcentaje_comparativo.textContent = "11,47%";

    //Variación de los Litros por Cuenca lechera
    aN_Li_x_c_IA.textContent = "0,3%";
    aN_Li_x_c_Men.textContent = "-17,1%";
    aSur_Li_x_c_IA.textContent = "20%";
    aSur_Li_x_c_IMen.textContent = "-14,4%";
    mYS_Li_x_c_IA.textContent = "15,8%";
    mYS_Li_x_c_IMen.textContent = "-13,8%";
    oes_Li_x_c_IA.textContent = "9,26%";
    oes_Li_x_c_IMen.textContent = "-17,3%";

    //% Solidos Útiles por Cuenca lechera
    cantTambos3.textContent = (cantTambos.textContent);
    s_cuenAbasNort.textContent = "7,25%";
    s_cuenAbasSur.textContent = "7,09%";
    s_cuenMyS.textContent = "7,29%";
    s_cuenO.textContent = "7,19%";
    ...
    graf_precio_litro.data.labels = ['Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24','Oct 24','Nov 24','Dic 24','Ene 25','Feb 25'];
    graf_precio_litro.data.datasets[0].data = [298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85,447.62,452.11,456.12,458.59,462.39];

    //Gráfico2
    graf_produccion_mensual.data.labels = graf_precio_litro.data.labels;
    graf_produccion_mensual.data.datasets[0].data = [146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34,231.3,217.3,215.24,194.85,163.57];

    //Gráfico3
    graf_solidos_utiles.data.labels = graf_precio_litro.data.labels;
    graf_solidos_utiles.data.datasets[0].data = [7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24,7.18,7.11,7.10,7.07,7.21];
