...
type: 'bar',
data: {
labels: ['Abr 22','May 22','Jun 22','Jul 22','Ago 22','Sep 22','Oct 22','Nov 22','Dic 22','Ene 23','Feb 23','Mar 23','Abr 23'],
datasets: [{
    label: 'Valores en pesos $',
    data: [44.31,46.87,49.21,52.06,54.34,57.03,59.88,63.17,67.76,71.83,76,84.09,92.73],
    backgroundColor: [
        'rgba(0,55,203,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data: [164.54,177.47,174.59,187.25,204.09,208.46,217.48,204.07,201.86,185.91,154.9,166.59,170.36],
    backgroundColor: [
        'rgba(255,120,0,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data:  [7.36,7.43,7.42,7.36,7.26,7.20,7.18,7.11,7.00,7.00,7.08,7.21,7.40],
    backgroundColor: [
        'rgba(255,173,0,0.5)',
    ],
    borderColor: [
