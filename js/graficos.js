...
type: 'bar',
data: {
labels: ['abr 21', 'may 21','jun 21', 'jul 21', 'ago 21', 'sep 21', 'oct 21', 'nov 21', 'dic 21', 'ene 22', 'feb 22', 'mar 22', 'abr 22', 'may 22'],
datasets: [{
    label: 'Valores en pesos $',
    data: [28.40, 30.15, 31.69, 32.73, 33.42, 33.90, 34.14, 35.52, 36.15, 36.58, 38.43, 41.12, 44.31, 46.87],
    backgroundColor: [
        'rgba(0,55,203,0.5)',
    ],
    borderColor: [
...
type: 'bar',
data: {
labels: ['mar 21', 'abr 21', 'may 21','jun 21', 'jul 21', 'ago 21', 'sep 21', 'oct 21', 'nov 21', 'dic 21', 'ene 22', 'feb 22', 'mar 22', 'abr 22', 'may 22'],
datasets: [{
    label: 'Producción mensual de leche cruda en millones de litros',
    data: [174.48, 170.58, 182.11, 180.98, 195.47, 211.09, 214.02, 227.06, 212.12, 203.04, 179.11, 155.57, 169.09, 164.54, 177.47],
    backgroundColor: [
        'rgba(255,120,0,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data: [7.07, 7.17, 7.29, 7.23, 7.19, 7.14, 7.12, 7.09, 7.02, 6.96, 6.96, 7.09, 7.26, 7.36, 7.43],
    backgroundColor: [
        'rgba(255,173,0,0.5)',
    ],
    borderColor: [
