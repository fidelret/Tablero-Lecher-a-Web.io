...
type: 'bar',
data: {
labels: ['Mar 23','Abr 23','May 23','Jun 23','Jul 23','Ago 23','Sep 23','Oct 23','Nov 23','Dic 23','Ene 24','Feb 24','Mar 24'],
datasets: [{
    label: 'Valores en pesos $',
    data: [84.09,92.73,100.74,107.39,112.51,117.42,122.66,133.39,151.47,193.79,246.11,298.57,342.39],
    backgroundColor: [
        'rgba(0,55,203,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data:  [166.59,170.36,176.63,177.32,191.13,209.23,212.88,223.64,207.35,195.98,174.88,146.65,161.14],
    backgroundColor: [
        'rgba(255,120,0,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data:  [7.21,7.40,7.47,7.39,7.36,7.27,7.24,7.20,7.19,7.13,7.07,7.23,7.3],
    backgroundColor: [
        'rgba(255,173,0,0.5)',
    ],
    borderColor: [
