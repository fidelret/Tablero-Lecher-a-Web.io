...
type: 'bar',
data: {
labels: ['Dic 23','Ene 24','Feb 24','Mar 24','Abr 24','May 24','Jun 24','Jul 24','Ago 24','Sep 24','Oct 24','Nov 24','Dic 24'],
datasets: [{
    label: 'Valores en pesos $',
    data: [193.79,246.11,298.57,342.39,368.87,401.26,421.8,430.58,441.6,443.85,447.62,452.11,456.12],
    backgroundColor: [
        'rgba(0,55,203,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data:  [195.98,174.88,146.65,161.14,156.5,166.62,170.53,192.91,206.94,217.34,231.3,217.3,215.24],
    backgroundColor: [
        'rgba(255,120,0,0.5)',
    ],
    borderColor: [
...
datasets: [{
    ...
    data:  [7.13,7.07,7.23,7.3,7.45,7.56,7.45,7.41,7.32,7.24,7.18,7.11,7.10],
    backgroundColor: [
        'rgba(255,173,0,0.5)',
    ],
    borderColor: [
